...
BIN_DIR = bin/$(module)
GEN_DSP_DIR = src/$(module)/gen_dsp
...
$(TARGET_ELF): $(CPP_OBJ) $(C_OBJ)  $(ASM_OBJ)
...
$(C_OBJ): %.o : $$(filter $$(PERCENT)/$$(notdir %).c, $(ALL_SRC))
	...
	@echo $(CC) $(DEFINES) $(ALL_INCLUDES) $(CFLAGS) -o $@ -c $< -MMD -MP -MF "$(@:%.o=%.d)"
	@$(CC) $(DEFINES) $(ALL_INCLUDES) $(CFLAGS) -o $@ -c $< -MMD -MP -MF "$(@:%.o=%.d)"

$(CPP_OBJ): %.o : $$(filter $$(PERCENT)/$$(notdir %).cpp, $(ALL_CPP_SRC))
	@echo compiling cpp: $(notdir $<)
	@echo $(LD) $(DEFINES) $(ALL_INCLUDES) $(CPPFLAGS) -o $@ -c $< -MMD -MP -MF "$(@:%.o=%.d)"
	@$(LD) $(DEFINES) $(ALL_INCLUDES) $(CPPFLAGS) -o $@ -c $< -MMD -MP -MF "$(@:%.o=%.d)"
